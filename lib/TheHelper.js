...
class TheHelper {
  ...
  static showGeneralHelp () {
    ...
    console.log(COLORS.BLUE,"$gitbook-setup [help] deploy ",COLORS.RED,"            --> ", COLORS.GREEN,"Deploy to somewhere. [help] give you more detailed information about the command.",COLORS.RESET_FONT);
